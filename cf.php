...
if(isset($_POST['submit'])){
    $to = "jatinsehgal466@gmail.com"; // Your email address
    $name = $_POST['name'];
    $from = $_POST['email'];
                                ...
                                <div class="contact_form_inner">
                                    <div class="contact_field">
                                        ...
                                        <form method="post" action="">
                                            ...
                                            <input type="text" class="form-control form-group" placeholder="Email" name="email" />
                                            <textarea class="form-control form-group" placeholder="Message" name="message"></textarea>
                                            <button type="submit" name="submit" class="contact_form_submit">Send</button>
                                        </form>
                                        <?php if($messageSent): ?>
